...
class PortaBoogly(Card):
    ...
    def play(self, player):
        ...
        if self.socket.selected_cards and self.socket.selected_cards_wild:
            ...
            self.select_only_monsters(1, player,
                                      porta)  # issue with meera boogly, if this is run then meera is played before card can be selected
            self.socket.play_stack.append(self)
...
class HuntoOogly(Card):
    ...
    def play(self, player):
        ...
        if self.socket.selected_cards_wild:
            ...
            self.select_cards_wild(1,
                                   player)  # issue with meera boogly, if this is run then meera is played before card can be selected
            self.socket.play_stack.append(self)
...
class JusteeZoogly(Card):
    ...
    def play(self, player):
        ...
        if self.socket.selected_cards:
            ...
            self.select_cards(1, player,
                              justee)  # issue with meera boogly, if this is run then meera is played before card can be selected
            self.socket.play_stack.append(self)
...
class ZookeeZoogly(Card):
    ...
    def play(self, player):
        ...
        if self.socket.selected_cards:
            ...
            self.select_only_monsters(1, player,
                                      zookee)  # issue with meera boogly, if this is run then meera is played before card can be selected
            self.socket.play_stack.append(self)
...
class ZoomiZoogly(Card):
    ...
    def play(self, player):
        ...
        if self.socket.selected_cards:
            ...
            self.select_only_monsters(1, player,
                                      zoomi)  # issue with meera boogly, if this is run then meera is played before card can be selected
            self.socket.play_stack.append(self)
...
class Player(object):
    def __init__(self, player_id=""):
        starter_deck = [ZookeeZoogly(), ZookeeZoogly(), ZookeeZoogly(), ZookeeZoogly(), DirtySocks(), DirtySocks(),
                        DirtySocks(), DirtySocks(), DirtySocks(), DirtySocks()]
        self.deck = Deck()
